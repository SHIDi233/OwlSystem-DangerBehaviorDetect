...
# #    server_client.connect(("127.0.0.1", 12000))
#     server_client.connect(("127.0.0.1", port))
                ...
                if dataset.mode == 'image':
                    ...
                    if vid_path[i] != save_path:  # new video
                        ...
                        if isinstance(vid_writer[i], cv2.VideoWriter):
                            vid_writer[i%3000].release()  # release previous video writer
                        if vid_cap:  # video
...
#'F:/yolo/yolov5-master/runs/train/exp/weights/best.pt'
# 'rtsp://192.168.10.187:8554/video.sdp'
#'E:/Tencent/QQFile/MobileFile/VID_20230319_165819.mp4'
#'F:/FFOutput/test 00_00_36-00_00_41.mp4'
#'F:/yolo/yolov5-master/runs/train/exp3/weights/best.pt'
#'F:/yolo/yolov5-master/runs/train/ten/exp/weights/best.pt'

def parse_opt():
    parser = argparse.ArgumentParser()
    parser.add_argument('--weights', nargs='+', type=str, default= 'F:/yolo/yolov5-master/models/yolov5s.pt', help='model path or triton URL')
    parser.add_argument('--source', type=str, default='rtsp://127.0.0.1:8554/video.sdp', help='file/dir/URL/glob/screen/0(webcam)')
