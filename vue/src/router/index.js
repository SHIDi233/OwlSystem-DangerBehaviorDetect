...
import h5 from "../components/htmlFlv.vue";
import cameraManager from "../components/cameraManage.vue"
...
import playerBackPage from "@/components/playerBackPage";
import regionDivision from "@/components/regionDivision";

import cameraMap from "@/components/MapContainer.vue"
        ...
        },
        {
          ...
          children:[
              ...
              },
            {
              path: "/playerback/:sid",
              name:'playerback',
              component:playerBackPage
            },
            {
                  path: "/regionDivision",
                  name:'regionDivision',
                  component:regionDivision
              },
          ]
        },
          // {
